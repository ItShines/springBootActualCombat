package com.springboot.actualcombat.spring2configure.el.config;
 ...
 */
@Configuration
@ComponentScan("com.springboot.actualcombat.spring2configure.el")
@PropertySource(value = "classpath:el/el.properties")
