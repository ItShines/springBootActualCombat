package com.springboot.actualcombat.spring1base.aop.pointcut;
...
public class LogAspect {
     ...
     * 通过@PointCut注解声明切点
     */
    @Pointcut(value = "@annotation(com.springboot.actualcombat.spring1base.aop.action.Action)")
     ...
     * @param joinPoint
     */
    @Before("execution(* com.springboot.actualcombat.spring1base.aop.service.MethodService.*(..))")
