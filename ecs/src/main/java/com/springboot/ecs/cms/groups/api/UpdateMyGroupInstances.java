...
import com.aliyuncs.cms.model.v20180308.UpdateMyGroupInstancesRequest;
 ...
 * @author wb-ryd460712
 */
public class UpdateMyGroupInstances {
    public static void main(String[] args) {
        ...
        UpdateMyGroupInstancesRequest myGroupInstances = new UpdateMyGroupInstancesRequest();
        //RegionId String 非必选 区域
        myGroupInstances.setRegionId("cn-beijing");
        //GroupId Long 必选 分组Id
        myGroupInstances.setGroupId(1328130L);
        ...
        // 发起请求
        try {
            UpdateMyGroupInstancesResponse response = client.getAcsResponse(myGroupInstances);
